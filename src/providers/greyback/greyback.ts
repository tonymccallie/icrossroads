...
export class GreybackProvider {
  rootUrl: string = "http://crossroads.server3.greyback.net";
  ...
  constructor(public http: Http, public httpClient: HttpClient) {
    ...
    this.headers.append(
      "Authorization",
      "Basic " + btoa("patrickkemp:Three3leaf")
    );
  ...
  getCommunity() {
    ...
    return this.http
      .get(
        this.rootUrl +
          "/ajax/plugin/community/community_posts/latest/department:1"
      )
      .map(result => result.json());
  }
  ...
  getSeries() {
    return this.http
      .get(this.rootUrl + "/ajax/plugin/message/message_series/json/category:1")
      .map(result => result.json());
  }
  ...
  getSeriesById(seriesId: number) {
    return this.http
      .get(
        this.rootUrl +
          "/ajax/plugin/message/message_messages/json/series:" +
          seriesId
      )
      .map(result => result.json());
  }
  ...
  getLatestSermon() {
    return this.http
      .get(
        this.rootUrl +
          "/ajax/plugin/message/message_messages/json/limit:1/category:1"
      )
      .map(result => result.json());
  }
  ...
  getEvents() {
    return this.http
      .get(
        this.rootUrl +
          "/ajax/plugin/news/news_articles/json/limit:10/category:1"
      )
      .map(result => result.json());
  }
  ...
  getCalendars() {
    return this.http
      .get(
        "https://secure.accessacs.com/api_accessacs_mobile/v2/10413/calendars",
        this.opts
      )
      .map(result => result.json());
  }
  ...
  getCalendar(index) {
    ...
    return new Promise(resolve => {
      this.httpClient
        .get(
          "http://api.serviceu.com/rest/events/occurrences/search?orgKey=9ccb6bd6-c8f2-4e89-8b1e-b8cfbc85c19d&format=json"
        )
        .subscribe(
          data => {
            resolve(data);
...
*/
  getCalendarX(index) {
    ...
    return this.http
      .get(
        "https://secure.accessacs.com/api_accessacs_mobile/v2/10413/events?&startdate=" +
          today +
          "&stopdate=" +
          end +
          "&pageIndex=" +
          index +
          "&pageSize=50&calendarids=58c08c0d-776d-4762-8180-0df5fcf1ae74",
        this.opts
      )
      .map(result => result.json());
  ...
  getEvent(eventId: string) {
    ...
    return this.http
      .get(
        "https://secure.accessacs.com/api_accessacs_mobile/v2/10413/events/" +
          eventId,
        this.opts
      )
      .map(result => result.json());
