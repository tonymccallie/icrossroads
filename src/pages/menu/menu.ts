...
export class MenuPage {
  ...
  openPage(page: PageInterface) {
    ...
    if (page.pageName == "LivePage") {
      this.iab.create("https://crossroadscc.churchonline.org/", "_system");
    } else {
